# About Me
### Currently pursuing a Diploma in Data Science from the Indian Institute of Technology, Madras, <br>further strengthening my knowledge in data-driven problem solving and advanced analytics. <br><br>As a detail-oriented Backend Developer and GenAI Enthusiast, I believe in building robust, scalable, and intelligent systems using modern technologies. <br>With a strong foundation in Python, FastAPI, SQL, and MongoDB, and a focus on creating backend architectures that are efficient, modular, and easy to maintain. <br><br>I have hands-on experience working with microservices, integrating open-source LLMs for context-aware applications, and building intuitive user interfaces using Streamlit.
